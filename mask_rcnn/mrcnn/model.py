...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
    ...
    rss = dataset.image_info[image_id]["source"]
    active_class_ids = np.array(dataset.get_source_class_ids(rss),
                                dtype=np.int32)
    ...
    image_meta = compose_image_meta(idx, original_shape, image.shape,
